...
struct Vertex {
	...
	glm::vec3 color;
	glm::vec2 texCoord;
	constexpr Vertex() : pos{}, color{}, texCoord{} {}
	constexpr Vertex(glm::vec2 pos, glm::vec3 color, glm::vec2 texCoord) : pos(pos), color(color), texCoord(texCoord) {}
