...
public:
	...
	dbgbuf(dbgbuf const &) = delete;                 // disallow copy construction
	void operator= (dbgbuf const &) = delete;          // disallow copy assignment
protected:
...
/// objects.  
class dbgstream : public std::basic_ostream<char, std::char_traits<char> >
{
public:
	/// Constructor.
	explicit dbgstream() :
